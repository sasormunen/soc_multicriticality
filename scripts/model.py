...
class RAModel():
    ...
    def __init__(self, G, n_tsteps, initial, tstep, turing_threshold, turing_update,
                ...
                0.0001,recording = [], write_every = 1):
        ...
        for folder in ["edgechanges","states","timeseries"]:
    ...
    def simulate(self):
        ...
        for tt in range(self.n_tsteps): #this tstep thing might need to be changed?
            ...
            if self.writeout == True and len(self.tracking_tvals) == self.write_every: #tt % writeout_step == 0: 
                print("writing out")
